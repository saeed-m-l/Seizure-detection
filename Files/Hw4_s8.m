%% Part 1 ( ready file -- preapare data) - subject 8
Fs = 256;
clear;close all;clc;
c1 = edfread("Sub8\WS8\chb08_02.edf");
c2 = edfread("Sub8\WS8\chb08_05.edf");
c3 = edfread("Sub8\WS8\chb08_11.edf");
c4 = edfread("Sub8\WS8\chb08_13.edf");
c5 = edfread("Sub8\WS8\chb08_21.edf");
c = edfread("Sub8\WOS8\chb08_17.edf");
s_time = [2699,2855,2987,2416,2082];
...
test_data = [features_s5;features_ns2;features_s4;features_ns5];
% feature Selection
%%
