...
% For sub 14
clear;close all;clc;
c1 = edfread("Sub14\WS14\chb14_03.edf");
c2 = edfread("Sub14\WS14\chb14_06.edf");
c3 = edfread("Sub14\WS14\chb14_11.edf");
c4 = edfread("Sub14\WS14\chb14_17.edf");
c5 = edfread("Sub14\WS14\chb14_18.edf");
c6 = edfread("Sub14\WS14\chb14_27.edf");
c = edfread("Sub14\WOS14\chb14_20.edf");
s_time = [1985,1910,1837,3238,1038,2832];
...
train_data = [features_s1;features_ns3;features_s2;features_ns4;features_s3;features_ns1;features_s4;features_ns5];
% for test
features_s5 = getFeature(s5);
features_s6 = getFeature(s6);
features_ns2 = getFeature(ns2);
test_data = [features_s5;features_ns6;features_s6;features_ns2];
% feature Selection
%%
